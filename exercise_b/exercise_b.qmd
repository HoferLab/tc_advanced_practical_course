...
The ZIF-8 system Zn(2-methylimidazolate)~2~ crystallizes in the non-centrosymmetric cubic space group I43m (space group no. 217) with a lattice parameter of approx 1.7 nm. The cubic unit cell contains a total of 2 Zn^2+^ cations that are tetrahedrally coordinated by the 24 2-methylimidazolate linkers. The pore structure of ZIF-8 is similar to the topology of a prototypic sodalite zeolite (hence the name zeolitic imidazolate framework). Several studies have investigated ZIF systems with respect to their CO~2~ storage capacity [5-8].
