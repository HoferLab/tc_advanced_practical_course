...
### Vibrational spectroscopy of a diatomic molecule at the example of $\mathrm{H_2}$ {.unnumbered}
...
ii) using `Python`/`R` datascience routines,  <br>
...
### Stretch Vibration in a Polyatomic Molecule {.unnumbered}
...
iv) Analyse both a hydrated ($\mathrm{^1H}$) and deuterated system ($\mathrm{^2D}$) 
